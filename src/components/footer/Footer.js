      ...
      <div className='max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-4 text-center border-b-2 border-blue-500 py-4'>
        {
            section.map((section,index)=>(
                <div key={index}>
                    <h6 className='text-blue-900 font-bold uppercase pt-2'>
                        {section.title}
                    </h6>
                    <ul>
        ...
        <div className='col-span-2 pt-8 md:pt-2'>
            ...
            <div className='flex flex-col sm:flex-row sm:justify-center sm:items-center text-center mx-auto mt-2'>
                <button className="inline-block font-semibold tracking-wide border-none justify-center text-center bg-blue-900 hover:text-blue-900 duration-300 px-8 sm:px-16 py-2 font-[Poppins] rounded-xl md:mr-15 md:rounded-md md:text-white w-full md:w-auto min-w-[200px] mx-0 sm:mx-6">
        ...
        sm:flex-row text-center text-blue-500'>
        ...
        <div className='flex items-center justify-center mx-auto'>
            <button className='grid grid-cols-1'>
              <a className='flex text-center text-blue-500 font-semibold text-xl hover:text-slate-200 mb-10 scroll-smooth' href="/">
                Villa Regina
            </a>
            </button>
        </div>
