...
const TestimonialData = [
    ...
    },
    {
        id: 3,
        name: "Alonso Diaz.",
        text: "Rápidos y confiables. Me solucionaron un problema con la batería en el mismo día. Excelente atencion ¡Muy buen precio!.",
        imag: Imagen3,
    },
    {
        id: 4,
            ...
            <div className='bg-black/30'>
                <div className="container">
                    <div data-aos="fade-up" className='text-center py-5 mb-12'>
                        <h1 className='text-3xl md:text-5xl text-white font-bold'>Esto dicen de nosotros</h1>
                    </div>
